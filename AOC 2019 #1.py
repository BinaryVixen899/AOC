...
# The Fuel Counter-Upper needs to know the total fuel requirement. To find it, individually calculate the fuel needed for the mass of each 
...
#---------Importing Data-------------
new_list = [int(item) for item in fileinput.input(r"C:\Users\leala\OneDrive\Documents\Coding\AOC2019\AOC2019Problem1Input.txt")]
print(new_list)
# exit()
# -------Calculation----------
...
for item in new_list: 
    Mass = item
    MassCalculationPreRoundDown = (Mass / 3 ) 
    MassPostDown = math.trunc(MassCalculationPreRoundDown)
    FinalResult = MassPostDown - 2
    testlist.append(FinalResult)

print(testlist)
print(sum(testlist))

# [something_involving(x) for x in iterable]
# For example, [int(x) for x in fileinput.input()]
