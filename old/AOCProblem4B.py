...
for passphraserow in passphrasecollection:
    totalcount+= 1
    passphraserow = passphraserow.split()
    passphraserow.sort()
    print("Passphrase row:", passphraserow)
    
    for word in passphraserow: #OH, it's doing digits
        sortedword = ''.join(sorted(word))
        newpassphraserow.append(sortedword)
